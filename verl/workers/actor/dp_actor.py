...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto):
        ...
        algorithm = _get_enabled_bash_coding_algorithm(self.config)
        algorithm_debug_metrics = data.meta_info.get("algorithm_debug_metrics", None)
        temperature = data.meta_info["temperature"]
        ...
        metrics = {}
        if algorithm_debug_metrics is not None:
            append_to_dict(metrics, algorithm_debug_metrics)
            ...
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if (
                        ...
                        and algorithm.compute_policy_loss is not None
                    ):
                        policy_loss_kwargs = _inject_algorithm_hparams(
                            algorithm.compute_policy_loss,
                            self.config,
                            {
                        ...
                        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower = (
                            algorithm.compute_policy_loss(**policy_loss_kwargs)
                        )
                    else:
