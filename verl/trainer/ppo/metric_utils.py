...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> Dict[str, Any]:
    ...
    metrics = {
        ...
        **(
        ...
        .detach()
        .item(),
        "episode/reward/mean": batch.non_tensor_batch["episode_rewards"][unique_idx]
        .mean()
        .item(),
        "episode/reward/max": batch.non_tensor_batch["episode_rewards"][unique_idx]
        .max()
        .item(),
        "episode/reward/min": batch.non_tensor_batch["episode_rewards"][unique_idx]
        .min()
        .item(),
        "episode/length/mean": batch.non_tensor_batch["episode_lengths"][unique_idx]
        .mean()
        .item(),
        "episode/length/max": batch.non_tensor_batch["episode_lengths"][unique_idx]
        .max()
        .item(),
        "episode/length/min": batch.non_tensor_batch["episode_lengths"][unique_idx]
        .min()
        .item(),
        "episode/tool_call_count/mean": batch.non_tensor_batch["tool_callings"][
            unique_idx
        ]
        .mean()
        .item(),
